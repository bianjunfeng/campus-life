...
public enum BusinessErrorCode implements ErrorCode {
    ...
    WECHAT_PAYMENT_NOT_INTEGRATED(503603, "微信支付能力未接入，请联系平台", HttpStatus.SERVICE_UNAVAILABLE),
    WECHAT_PAYMENT_CALLBACK_VERIFY_NOT_IMPLEMENTED(503604, "微信支付回调验签未接入，已拒绝处理", HttpStatus.SERVICE_UNAVAILABLE),
